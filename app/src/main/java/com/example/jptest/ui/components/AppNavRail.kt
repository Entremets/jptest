package com.example.jptest.ui.components
...
import com.example.jptest.ui.jptestDestinations
...
fun AppNavRail(currentRoute: String, navigateToHome: () -> Unit, navigateToInterests: () -> Unit, modifier: Modifier = Modifier) {
    NavigationRail(
        ...
        NavigationRailItem(
            selected = currentRoute == jptestDestinations.HOME_ROUTE,
        ...
        NavigationRailItem(
            selected = currentRoute == jptestDestinations.INTERESTS_ROUTE,
            onClick = navigateToInterests,
            icon = { Icon(Icons.Filled.List, stringResource(R.string.interests_title)) },
...
fun PreviewAppNavRail() {
    JptestTheme  {
        AppNavRail(
            currentRoute = jptestDestinations.HOME_ROUTE,
            navigateToHome = {},
            navigateToInterests = {},
        )
    }
